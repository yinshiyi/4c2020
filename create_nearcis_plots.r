...
par(mar=c(4, 0, 0.08, 0))
par(mgp=c(0, 0, 0))

image(as.matrix(log(0.0005+factor_m/factor_t*sc[(1+plot_from_shift/1000):(dim(sc)[1]-plot_to_shift/1000), 3*(45:2)-4],base=2)), col=shades, zlim=c(-low_cutoff,0.2),axes=F, xlab = "", cex.lab = 2.2)
